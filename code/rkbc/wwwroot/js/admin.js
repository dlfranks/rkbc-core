    ...
    if (edit && editPost) {
        ...
        if (typeof window.orientation !== "undefined" || navigator.userAgent.indexOf('IEMobile') !== -1) {
            ...
            window.tinymce.init({
                ...
                plugins: 'autosave preview searchreplace visualchars fullscreen code codesample table hr pagebreak autoresize nonbreaking anchor insertdatetime advlist lists textcolor wordcount imagetools colorpicker',
